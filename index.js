...
client.on('message', message => {
    ...
    if (message.content === '샤디스 계급') { //조사병단 기본적인 계급
        ...
        .addFields(
            { name: '• <@&701403514160545792>', value: '조사병단의 총괄 책임자 및 최고 지휘관이다. 장거리 수색 진형 전체를 컨트롤하며 작전 목표 수행을 위한 모든 책임을 진다. 2~40명 또는 합동 조사에서는 6~70명까지 통솔해야 하는 만큼 뛰어난 통솔력을 가지고 전반적인 벽외조사의 이해도를 가지고 있어야 한다.', inline: false },
            { name: '• <@&701403526433341531>', value: '벽외조사 섹션 책임자 및 지휘권 2인자이다. 단장의 부재시 진형의 지휘권을 이어받는다. 반장이 한 반만을 통제할 수 있다면 분대장은 반장들을 통제하고 좌익이나 우익등 전체를 컨트롤한다. ', inline: false },
            { name: '• <@&701403563083038760>', value: '단장 따가리다', inline: false },
            { name: '• <@&701403575070490716>', value: '각 반을 책임지는 반장이다. 각 조사마다 한 반에는 3~6명정도의 병사들로 구성돼 출전하며, 반들은 장거리 수색진형에서 살을 이룬다. 장교급의 직책인 만큼 뛰어난 리더십과 통솔력을 가지며 반을 통솔하는 능력과 책임감을 가져야한다.', inline: false },
            { name: '• <@&711553803236933685>', value: '벽외조사에서 뛰어난 활약을 하는 병사들에게 수여되는 계급이다. 벽외조사의 높은 참여율과 뛰어난 실력을 필요로 한다.', inline: false },
            { name: '• <@&711553800179286037>', value: '벽외조사에서 뛰어난 활약을 하는 병사들에게 수여되는 계급이다. 벽외조사의 높은 참여율과 뛰어난 실력을 필요로 한다. ', inline: false },
            { name: '• <@&711553978059587634>', value: '어느정도 벽외조사에서 살아남았으며 벽외조사에 익숙해져서  올바른 장거리 수색진형을 구현할 수 있는 계급이다. 평균정도의 전투력을 가지고 있으며 각 벽외조사마다 작전의 이해도와 거인과의 전투에서 숙달돼있다. 대부분의 병사들은 이 직책까지 쉽게 올라올 수 있다.', inline: false },
            { name: '• <@&711511435783569468>', value: '첫 벽외조사에서 살아온 병사 및 입단한지 얼마 안 된 신병이다. 조사병단에 입단한지 오랜 시간이 흐르지 못했거나 거인을 구축하기 위한 실력 베이스가 부족할 경우 이 계급에서 오랫동안 머무르는 상황이 발생할 수도 있다. 이 경우에는 실력을 갈고 닦아 숙련병으로 진급해야 한다.', inline: false },
            { name: '• <@&703096881403658250>', value: '벽외조사에 참가하기 위해 훈련중인 병사들이다. 조사병단에 입단했으나 아직 벽외조사에 참가하지 못한 병사들로 구성돼 있다. 이들은 벽외조사에 참가하여 더 높은 계급으로 승진할 수 있다.', inline: false }
        )
        message.channel.send(embed)
    }
