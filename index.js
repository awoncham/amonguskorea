...
client.on('guildMemberAdd', member => {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setImage('https://cdn.discordapp.com/attachments/742051945472065546/777470769764630548/2BbK.gif')
      channel.send(embed)
    });
...
client.on('guildMemberRemove', member => {
    ...
    const embed = new Discord.MessageEmbed()
      .setColor('#FF0000')
      .setDescription(`${member} 님께서 조사병단을 떠나셨습니다`)
      .setImage('https://cdn.discordapp.com/attachments/742051945472065546/777471558741524500/ShingekinoKyoujin-16-Large14.jpg')
      channel.send(embed)
  });
...
client.on('message', message => {
    ...
    if (message.content === '샤디스 계급') { //조사병단 기본적인 계급
        ...
        .setDescription
        (
        '**`조사병단 계급 배치도`**\n\n<@&701403514160545792> | 조사병단의 총괄 책임자 및 최고 지휘관이다\n\n<@&701403526433341531> | 벽외조사 섹션 책임자 및 지휘권 2인자이다\n\n<@&701403563083038760> | 단장 따까리다\n\n<@&701403575070490716> | 각 반을 책임지는 반장이다\n\n<@&711553803236933685> | 일반 사병급 병사에서 최고로 올라갈 수 있는 계급이다\n\n<@&711553800179286037> | 벽외조사에서 뛰어난 활약을 하는 병사들에게 수여되는 계급이다\n\n<@&711553978059587634> | 어느정도 벽외조사에서 살아남았으며 벽외조사에 익숙해져서 올바른 장거리 수색진형을 구현할 수 있는 계급이다\n\n<@&711511435783569468> | 첫 벽외조사에서 살아온 병사 및 입단한지 얼마 안 된 신병이다\n\n<@&703096881403658250> | 벽외조사에 참가하기 위해 훈련중인 병사들이다. 조사병단에 입단했으나 아직 벽외조사에 참가하지 못한 병사들로 구성돼 있다'
        )
        message.channel.send(embed)
    }
